...
namespace ABPNext.LMS.ObjectExtending
{
    public static class LMSDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the LMSEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
