...
{
    public class LMSDbMigrationService : ITransientDependency
    {
        public ILogger<LMSDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ILMSDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public LMSDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ILMSDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<LMSDbMigrationService>.Instance;
        }
