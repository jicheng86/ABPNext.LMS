...
namespace ABPNext.LMS.Web.Menus
{
    public class LMSMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public LMSMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<LMSResource>>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("LMS.Home", l["Menu:Home"], "/"));
